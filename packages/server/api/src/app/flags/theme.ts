...
export const defaultTheme = generateTheme({
    primaryColor: '#6e41e2',
    websiteName: process.env.AP_APP_TITLE || 'Activepieces',
    fullLogoUrl: process.env.AP_LOGO_URL || 'https://cdn.activepieces.com/brand/full-logo.png',
    favIconUrl: process.env.AP_FAVICON_URL || 'https://cdn.activepieces.com/brand/favicon.ico',
    logoIconUrl: process.env.AP_LOGO_URL || 'https://cdn.activepieces.com/brand/logo.svg',
})
